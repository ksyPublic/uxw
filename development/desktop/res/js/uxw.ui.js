...
var modalLayer = function modalLayer(UI) {
  ...
  var layerClick = function layerClick(event) {
    ...
    _vendor_EventHandler__WEBPACK_IMPORTED_MODULE_6__["default"].one(config.closeButton, 'click', layerClose);
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    key: "show",
    value: function show(message, timer) {
      var _this = this;

      this._message = message;
      this._element = document.querySelector('#toast');
    ...
    value: function getContainer(template) {
      if (Message.HOLDER === null) {
        ...
        document.querySelector('#toast').appendChild(Message.HOLDER);
      }
